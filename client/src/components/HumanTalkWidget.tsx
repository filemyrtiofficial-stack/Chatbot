        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed z-50 flex flex-col bg-white shadow-2xl md:top-1/2 md:right-4 md:left-auto md:bottom-auto md:h-auto md:w-[90vw] md:max-w-[420px] md:-translate-y-1/2 md:rounded-xl bottom-0 right-0 left-0 w-full h-[calc(100vh-0.5rem)] max-h-[calc(100vh-0.5rem)] rounded-t-xl my-1 md:my-2 md:-mt-[190px]"
              role="dialog"
              aria-modal="true"
            ...
            >
              ...
              <div className="flex items-center justify-between border-b border-blue-700/20 bg-[#026CB6] px-2.5 sm:px-3 md:px-4 py-2 md:py-2.5 text-white shadow-sm flex-shrink-0">
                <div className="flex items-center gap-1.5 sm:gap-2 md:gap-2.5 min-w-0 flex-1">
                  ...
                  <div className="min-w-0 flex-1">
                    <h2 id="human-talk-title" className="text-xs sm:text-sm md:text-base font-semibold leading-tight truncate">
                      Talk to a Real Person
                    </h2>
                    <p className="text-[9px] sm:text-[10px] md:text-xs text-blue-100/90 mt-0.5 line-clamp-1">Get instant help — real people, real answers</p>
                  </div>
                </div>
                <button
                  onClick={() => setIsOpen(false)}
                  className="rounded-full p-1 md:p-1.5 transition-all hover:bg-white/20 active:scale-95 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-transparent flex-shrink-0 ml-1.5"
              ...
              {/* Content Area */}
              <div className="flex-1 overflow-hidden px-2.5 sm:px-3 md:px-4 py-2 md:py-3 flex flex-col min-h-0">
                {isSubmitted ? (
                  <motion.div
                  ...
                  <>
                    ...
                    <div className="mb-2 md:mb-3 rounded-lg border border-slate-200 bg-gradient-to-br from-slate-50 to-blue-50/30 p-1.5 sm:p-2 md:p-2.5 shadow-sm flex-shrink-0">
                      <div className="flex flex-col sm:flex-row gap-1.5 sm:gap-2">
                        {/* Phone Number */}
                        <a
                          href={`tel:${companyPhoneNumber.replace(/\s/g, '')}`}
                          className="group flex-1 flex items-center justify-center gap-1 sm:gap-1.5 rounded-lg bg-white px-2 md:px-3 py-1.5 md:py-2 text-[#026CB6] transition-all hover:bg-[#026CB6] hover:text-white hover:shadow-md"
                        >
                          <svg
                          ...
                          <span className="text-[9px] sm:text-[10px] md:text-xs font-semibold break-all text-center">{companyPhoneDisplay}</span>
                        </a>
                        ...
                        <a
                          ...
                          className="group flex-1 flex items-center justify-center gap-1 sm:gap-1.5 rounded-lg bg-[#25D366] px-2 md:px-3 py-1.5 md:py-2 text-white transition-all hover:bg-[#20BA5A] hover:shadow-md"
                        >
                          <svg
                            className="h-3.5 w-3.5 md:h-4 md:w-4 transition-transform group-hover:scale-110 flex-shrink-0"
                            fill="currentColor"
                          ...
                          <span className="text-[9px] sm:text-[10px] md:text-xs font-semibold whitespace-nowrap">WhatsApp</span>
                        </a>
                      </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-2 md:space-y-3 flex-1 flex flex-col min-h-0" noValidate>
                      ...
                      <div className="flex-shrink-0">
                        ...
                        <input
                          ...
                          className={`w-full rounded-lg border px-2.5 sm:px-3 md:px-3 py-1.5 sm:py-2 md:py-2.5 text-xs sm:text-sm transition-all focus:outline-none focus:ring-2 focus:ring-offset-1 ${errors.name
                      ...
                      <div className="flex-shrink-0">
                        ...
                        <input
                          ...
                          className={`w-full rounded-lg border px-2.5 sm:px-3 md:px-3 py-1.5 sm:py-2 md:py-2.5 text-xs sm:text-sm transition-all focus:outline-none focus:ring-2 focus:ring-offset-1 ${errors.phone
                            ? 'border-red-300 bg-red-50 focus:border-red-500 focus:ring-red-500/20'
                            : 'border-slate-300 bg-white focus:border-[#026CB6] focus:ring-[#026CB6]/20'
                            }`}
                        />
                      ...
                      <div className="flex-1 flex flex-col min-h-0">
                        ...
                        <textarea
                          ...
                          className={`w-full resize-none rounded-lg border px-2.5 sm:px-3 md:px-3 py-1.5 sm:py-2 md:py-2.5 text-xs sm:text-sm transition-all focus:outline-none focus:ring-2 focus:ring-offset-1 flex-1 min-h-[60px] ${errors.query
                            ? 'border-red-300 bg-red-50 focus:border-red-500 focus:ring-red-500/20'
                            : 'border-slate-300 bg-white focus:border-[#026CB6] focus:ring-[#026CB6]/20'
                            }`}
                        />
